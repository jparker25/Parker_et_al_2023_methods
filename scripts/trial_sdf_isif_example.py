...
axes[5].set_xlabel("Time(s)"); axes[5].set_ylabel("ISIF (s)") # Label the SDF axes
...
plt.tight_layout()
plt.savefig("../figures/trial_sdf_isif_example.pdf")
plt.close()

os.system("open ../figures/trial_sdf_isif_example.pdf")